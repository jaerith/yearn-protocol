...
interface ERC2746 {
    ...
    */
    function getRuleSetProps(address _owner, bytes32 _ruleSetName) external view returns (string memory, bool, bool, uint, uint, bytes32[] memory);
    ...
    */
    function getRuleTreeProps(address _owner) external view returns (bytes32, string memory, bytes32);
